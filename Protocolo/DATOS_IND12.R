...
afil_seg_ind <- readRDS("Datos/Originales_Mayo_2020/bd_afiliados12_23062020.rds") %>% 
...
bd_empresas_app <- info_consolidada %>%
  select(id_empresa, seg_basico, seg_medio, seg_joven, seg_alto, numempleados) %>% 
...
# SALIDA
saveRDS(info_actualizada, file = "App/Data/info_actualizada12_23062020.rds")
saveRDS(info_actualizada, file = "Datos/Originales_Abril_2020/info_actualizada12_23062020.rds")
 
# # Informacion adicional
# info_piramide <- readRDS("Datos/Originales_Marzo_2020/ConsolidacionMAR2020.rds") %>% 
